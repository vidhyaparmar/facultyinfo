<div id="profileDiv">
  ...
  <div class="row">
    ...
    <div class="col-xs-10 col-md-4">
       <h3 style="margin-left:30px;"> <b>Dr.Preeti Singh</b></h3>
          <br/>
          <center><img class = "img-thumb" src="./images/Preeti Singh.jpg" / style="border-radius:5px;"></center>
        </div>
      ...
      <tr> 
        ...
        <tr>
          <td      ><b>Detailed Resume</b></td>
           <td     id="height" ></td>
          <td       colspan="2" >  <a href="https://docs.google.com/viewer?a=v&pid=sites&srcid=ZGVmYXVsdGRvbWFpbnxkcnByZWV0aXNpbmdoaWlwc2RhdnZ8Z3g6MmVmOTgyNmFiNDA3ZTM3YQ" >Click here...</a> </td>
        </tr>  
      </table>
