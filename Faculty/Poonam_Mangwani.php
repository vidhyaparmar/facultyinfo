<div id="profileDiv">
  ...
  <div class="row">
    ...
    <div class="col-xs-10 col-md-4">
       <h3 style="margin-left:30px;"> <b>Ms.Poonam mangwani</b></h3>
          <br/>
          <center><img class = "img-thumb" src="./images/Poonam Mangwani.jpg" /></center>
        </div>
    ...
    <div class="col-xs-4 col-md-7">
      ...
      <tr> 
        ...
        <td><b>Specialization</b></td>
          <td id="height"    > 
        <td >XML,Data Base, Object Oriented S/W Engg.  </td>
      </tr>
        ...
        <tr>
          <td      ><b>E-Mail id</b></td>
           <td     id="height" ></td>
          <td       colspan="2" ><a href="mailto:pmangwani@yahoo.com">pmangwani@yahoo.com</a> </td>
        </tr>   
