<div id="profileDiv">
  ...
  <div class="row">
    ...
    <div class="col-xs-10 col-md-4">
       <h3 style="margin-left:30px;"> <b>Mr.Pradeep Jatav</b></h3>
          <br/>
          <center><img class = "img-thumb" src="./images/Pradeep Jatav.jpg" /></center>
        </div>
      ...
      <tr> 
        ...
        <tr>
          <td valign="top" ><b>Phone</b></td>
           <td id="height" ></td>
          <td colspan="2" >+91-9713038949</td>
        </tr> 
        <tr>
          <td  ><b>E-Mail id</b></td>
           <td  id="height" ></td>
          <td  colspan="2" ><a href="mailto:p.jatav84@gmail.com">p.jatav84@gmail.com</a> </td>
        </tr>   
        ...
        <tr>
          <td ><b>Detailed Resume</b></td>
           <td id="height" ></td>
          <td colspan="2" >  <a href="https://docs.google.com/viewer?a=v&pid=sites&srcid=ZGVmYXVsdGRvbWFpbnxwcmFkZWVwamF0YXZpaXBzfGd4Ojc4NWM3Y2E2NDA3MTVkODA" >Click here...</a> </td>
        </tr>  
      </table>
