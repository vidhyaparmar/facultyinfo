<div id="profileDiv">
  ...
  <div class="row">
    ...
    <div class="col-xs-10 col-md-4">
       <h3 style="margin-left:30px;"> <b>Dr.Gaurav Purohit</b></h3>
          <br/>
          <center><img class = "img-thumb" src="./images/Gaurav Purohit.jpg" / style="border-radius:5px;"></center>
        </div>
    ...
    <div class="col-xs-4 col-md-7">
      ...
      <tr> 
        ...
        <tr>
          <td      ><b>E-Mail id</b></td>
           <td     id="height" ></td>
          <td       colspan="2" ><i> gaurav.purohit6@gmail.com</i> </td>
        </tr>   
