<div id="profileDiv">
  ...
  <div class="row">
    ...
    <div class="col-xs-10 col-md-4">
       <h3 style="margin-left:30px;"> <b>Mr. Rajesh Verma</b></h3>
          <br/>
          <center><img class = "img-thumb" src="./images/Rajesh Verma.jpg" /></center>
        </div>
    ...
    <div class="col-xs-4 col-md-7">
      ...
      <tr>  
        ...
        <td id="height"> 
        <td>B.Sc(Electronics), PGDCA, MCA</td>
      </td>
    </tr>
      <tr> 
        ...
        <td ><b>Specialization</b></td>
          <td id="height"    > 
        <td >Basic Electronics,Digital Electronics,Microprocessor</td>
      </tr>
        ...
        <tr>
          <td><b>E-Mail id</b></td>
           <td id="height" ></td>
          <td colspan="2" ><a href="mailto:rajeesh_verma@yahoo.com">rajeesh_verma@yahoo.com</a> </td>
        </tr>   
        ...
        <tr>
          <td><b>Detailed Resume</b></td>
           <td id="height" ></td>
          <td colspan="2" >  <a href="https://onedrive.live.com/?cid=EEBE1E91D291BEB6&id=EEBE1E91D291BEB6%21143" >Click here...</a> </td>
        </tr>  
      </table>
